...
package org.sevenstar.component.fckeditor.tags;

import org.sevenstar.component.fckeditor.FCKeditor;
...
public class FCKeditorTag extends BodyTagSupport  {
   ...
   /**
	...
	public int doStartTag() throws JspException {
		...
		String contextUrl = ((HttpServletRequest)pageContext.getRequest()).getContextPath();
		if(toolbarSet!=null)
		...
		if (imageBrowserURL != null){
			...
			fcked.getConfig().put("ImageBrowserURL",contextUrl+"/editor/filemanager/browser/default/browser.html?Type=Image&Connector=connectors/jsp/connector");
		}
		if (flashBrowserURL != null){
			fcked.getConfig().put("FlashBrowserURL",flashBrowserURL);
		}else{
			fcked.getConfig().put("FlashBrowserURL",contextUrl+"/editor/filemanager/browser/default/browser.html?Type=Flash&Connector=connectors/jsp/connector");
		}
		if (linkUploadURL != null){
			fcked.getConfig().put("LinkUploadURL",linkUploadURL);
		}else{
			fcked.getConfig().put("LinkUploadURL",contextUrl+"/editor/filemanager/upload/simpleuploader?Type=File");
		}
		if (imageUploadURL != null){
			fcked.getConfig().put("ImageUploadURL",imageUploadURL);
		}else{
			fcked.getConfig().put("ImageUploadURL",contextUrl+"/editor/filemanager/upload/simpleuploader?Type=Image");
		}
