...
package org.sevenstar.component.fckeditor.connector;
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (!commandStr.equals("FileUpload"))
			...
			try {
				...
				File pathToSave = new File(getRealPath(currentDirPath, year,
						month, day), fileName);
				newName = nameWithoutExt + "." + ext;
				pathToSave = new File(getRealPath(currentDirPath, year, month,
						day), newName);
